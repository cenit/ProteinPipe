...
Write-Host "Installing Protein Pipeline dependecies:" -ForegroundColor Yellow
Write-Host "- cmake"
...
# g++ Installer
Write-Host "C++ compiler identification (g++)"
If( -Not (Get-Command g++ -ErrorAction SilentlyContinue) ){ # cmake not installed
...
Write-Host "Build Protein Pipeline with cmake-ninja" -ForegroundColor Yellow
& .\build.ps1
